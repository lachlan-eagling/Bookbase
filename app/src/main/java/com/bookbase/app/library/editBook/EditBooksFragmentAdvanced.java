...
public class EditBooksFragmentAdvanced extends Fragment {

    private String title;
    private int page;

    public static EditBooksFragmentAdvanced newInstance(int page, String title){
        EditBooksFragmentAdvanced addBooksFragmentBasic = new EditBooksFragmentAdvanced();
